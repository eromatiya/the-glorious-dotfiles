...
local check_if_playing = function()
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			print(media_buttons.play_button_image)
...
awful.spawn.easy_async_with_shell(mpd_startup, function()
	awful.spawn.easy_async_with_shell(kill_mpd_change_event_listener, function()
		update_all_content()
		awful.spawn.with_line_callback(mpd_change_event_listener, {
